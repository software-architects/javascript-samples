...
function loadWithAsyncAwait() {
    const list = document.getElementById('pokemonList'),
        prev = document.getElementById('prev'),
        next = document.getElementById('next'),
        loadingIndicator = document.getElementById('loadingIndicator'),
        service = new PokemonAsyncService();
    ...
    async function loadPokemons() {
        ...
        const result = await service.loadPokemons();
        loadingIndicator.hidden = true;
        prev.hidden = !result.previous;
        next.hidden = !result.next;
...
window.onload = loadWithCallback;
//window.onload = loadWithAsyncAwait;